...
public interface Constants
{
	...
	String APK_SEARCH = "happylauncher.search" ;
	String APK_FOLDER = "happylauncher.folder" ;
	String APK_SHORTCUT = "happylauncher.shortcut" ;
	String APK_SHORTCUT_LEGACY = "happylauncher.shortcut_legacy" ;
